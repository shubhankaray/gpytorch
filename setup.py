...
# For CPP Extension
ext_modules = [
    CppExtension("_gpytorch_solver", ["gpytorch/csrc/gpytorch_solver.cpp"], extra_compile_args=["-fopenmp",]),
]
if torch.cuda.is_available():
    ext_modules.append(
        CUDAExtension("_gpytorch_solver_cuda", [
            "gpytorch/csrc/gpytorch_solver_cuda.cpp",
            "gpytorch/csrc/gpytorch_solver_cuda_kernel.cu",
        ], libraries=["cusolver",]),
    )
